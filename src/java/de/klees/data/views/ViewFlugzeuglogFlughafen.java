 ...
 */
@Entity
@Table(name = "viewFlugzeuglogFlughafen")
@XmlRootElement
@NamedQueries({
  @NamedQuery(name = "ViewFlugzeuglogFlughafen.findAll", query = "SELECT v FROM ViewFlugzeuglogFlughafen v")})
public class ViewFlugzeuglogFlughafen implements Serializable {
  ...
  public ViewFlugzeuglogFlughafen() {
  }
